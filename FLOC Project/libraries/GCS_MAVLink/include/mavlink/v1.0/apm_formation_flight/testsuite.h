/** @file
 *	@brief MAVLink comm protocol testsuite generated from apm_formation_flight.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef APM_FORMATION_FLIGHT_TESTSUITE_H
#define APM_FORMATION_FLIGHT_TESTSUITE_H
...
static void mavlink_test_apm_formation_flight(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_test_common(system_id, component_id, last_msg);
	mavlink_test_apm_formation_flight(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_ff_flock_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ff_flock_status_t packet_in = {
	...
	mavlink_ff_flock_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.member_ids = packet_in.member_ids;
        	packet1.dist_to_goal = packet_in.dist_to_goal;
        	packet1.leader = packet_in.leader;
        	packet1.members_iv = packet_in.members_iv;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_flock_status_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ff_flock_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_flock_status_pack(system_id, component_id, &msg , packet1.time_usec , packet1.leader , packet1.members_iv , packet1.member_ids , packet1.dist_to_goal );
	mavlink_msg_ff_flock_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_flock_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.leader , packet1.members_iv , packet1.member_ids , packet1.dist_to_goal );
	mavlink_msg_ff_flock_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ff_flock_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_flock_status_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.leader , packet1.members_iv , packet1.member_ids , packet1.dist_to_goal );
	mavlink_msg_ff_flock_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ff_pf_field(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ff_pf_field_t packet_in = {
		93372036854775807ULL,
	73.0,
	101.0,
	129.0,
	...
	mavlink_ff_pf_field_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.x_att = packet_in.x_att;
        	packet1.y_att = packet_in.y_att;
        	packet1.z_att = packet_in.z_att;
        	packet1.x_rep = packet_in.x_rep;
        	packet1.y_rep = packet_in.y_rep;
        	packet1.z_rep = packet_in.z_rep;
        	packet1.x_norm = packet_in.x_norm;
        	packet1.y_norm = packet_in.y_norm;
        	packet1.z_norm = packet_in.z_norm;
        	packet1.coordinate_frame = packet_in.coordinate_frame;
        	packet1.regime_mask = packet_in.regime_mask;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_pf_field_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ff_pf_field_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_pf_field_pack(system_id, component_id, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.regime_mask , packet1.x_att , packet1.y_att , packet1.z_att , packet1.x_rep , packet1.y_rep , packet1.z_rep , packet1.x_norm , packet1.y_norm , packet1.z_norm );
	mavlink_msg_ff_pf_field_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_pf_field_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.regime_mask , packet1.x_att , packet1.y_att , packet1.z_att , packet1.x_rep , packet1.y_rep , packet1.z_rep , packet1.x_norm , packet1.y_norm , packet1.z_norm );
	mavlink_msg_ff_pf_field_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ff_pf_field_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_pf_field_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.coordinate_frame , packet1.regime_mask , packet1.x_att , packet1.y_att , packet1.z_att , packet1.x_rep , packet1.y_rep , packet1.z_rep , packet1.x_norm , packet1.y_norm , packet1.z_norm );
	mavlink_msg_ff_pf_field_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ff_vwp(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ff_vwp_t packet_in = {
		93372036854775807ULL,
	963497880,
	963498088,
	963498296,
	...
	mavlink_ff_vwp_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.lat = packet_in.lat;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_vwp_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ff_vwp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_vwp_pack(system_id, component_id, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.lat , packet1.lon , packet1.alt , packet1.spd );
	mavlink_msg_ff_vwp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_vwp_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.lat , packet1.lon , packet1.alt , packet1.spd );
	mavlink_msg_ff_vwp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ff_vwp_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_vwp_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.coordinate_frame , packet1.lat , packet1.lon , packet1.alt , packet1.spd );
	mavlink_msg_ff_vwp_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ff_rel_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ff_rel_state_t packet_in = {
		93372036854775807ULL,
	73.0,
	101.0,
	129.0,
	...
	mavlink_ff_rel_state_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        	packet1.dx = packet_in.dx;
        	packet1.dy = packet_in.dy;
        	packet1.dz = packet_in.dz;
        	packet1.dvx = packet_in.dvx;
        	packet1.dvy = packet_in.dvy;
        	packet1.dvz = packet_in.dvz;
        	packet1.coordinate_frame = packet_in.coordinate_frame;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_rel_state_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ff_rel_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_rel_state_pack(system_id, component_id, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.dx , packet1.dy , packet1.dz , packet1.dvx , packet1.dvy , packet1.dvz );
	mavlink_msg_ff_rel_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_rel_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.coordinate_frame , packet1.dx , packet1.dy , packet1.dz , packet1.dvx , packet1.dvy , packet1.dvz );
	mavlink_msg_ff_rel_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ff_rel_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_rel_state_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.coordinate_frame , packet1.dx , packet1.dy , packet1.dz , packet1.dvx , packet1.dvy , packet1.dvz );
	mavlink_msg_ff_rel_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ff_gps_error_assist(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ff_gps_error_assist_t packet_in = {
		93372036854775807ULL,
	963497880,
	17859,
	175,
	...
	mavlink_ff_gps_error_assist_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_usec = packet_in.time_usec;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_gps_error_assist_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ff_gps_error_assist_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_gps_error_assist_pack(system_id, component_id, &msg , packet1.time_usec , packet1.fix_type , packet1.eph , packet1.satellites_visible , packet1.alt_rel );
	mavlink_msg_ff_gps_error_assist_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_gps_error_assist_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.fix_type , packet1.eph , packet1.satellites_visible , packet1.alt_rel );
	mavlink_msg_ff_gps_error_assist_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ff_gps_error_assist_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ff_gps_error_assist_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.fix_type , packet1.eph , packet1.satellites_visible , packet1.alt_rel );
	mavlink_msg_ff_gps_error_assist_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_apm_formation_flight(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_ff_flock_status(system_id, component_id, last_msg);
	mavlink_test_ff_pf_field(system_id, component_id, last_msg);
	mavlink_test_ff_vwp(system_id, component_id, last_msg);
	mavlink_test_ff_rel_state(system_id, component_id, last_msg);
	mavlink_test_ff_gps_error_assist(system_id, component_id, last_msg);
}

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // APM_FORMATION_FLIGHT_TESTSUITE_H
