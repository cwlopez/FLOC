...
class flock_member
{
 ...
 public:
	...
	const Vector3i*	get_vel();				//returns a pointer to an array of the private velocity variables {_vx, _vy, _vz}
	const Vector3i* get_gV_L();	
...
class local_member : public flock_member
{
private:
	 //flock Leadership
