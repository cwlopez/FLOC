...
public:
	 ...
	 */
	//This function isn't necessary for the ArduPlane implementation of the XBees- the serial port should already be open
//	void begin(long baud);
	 ...
	 */
	void send(BetterStream *serial, XBeeRequest &request);
